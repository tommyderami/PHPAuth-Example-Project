...
<body>
    <div style="margin: 50px auto; text-align: center;">
        ...
        <label>Re-type Password:<input id="passwordRetypeInput" type="password" placeholder="password"></label><br>
    ...
    <script>
        function login(){
            ...
            let pswdRetype = document.getElementById('passwordRetypeInput').value;
            ...
            let url = `auth-proc.php?mode=2&email=${email}&password=${pswd}`;
            url = encodeURI(url);
